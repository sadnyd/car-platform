...
public class InventoryServiceClient {
    ...
    public Mono<InventoryAvailabilityResponse> checkAvailability(String carId) {
        ...
        return webClient.get()
                ...
                .doOnSuccess(response -> log.info("Availability check success for car {}: available={}", carId,
                        response.isAvailable()))
                .doOnError(error -> log.error("Availability check failed for car {}: {}", carId, error.getMessage()));
    }
